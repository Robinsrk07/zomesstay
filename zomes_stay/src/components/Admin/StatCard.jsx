...
const StatCard = ({
  title,
  value,
  delta,           // number (e.g. -43.2 or +19.8)
  icon,            // <Icon className="..." />
  barPct = 70,     // 0-100
  tone = "green",  // "green" | "rose" | "indigo"
}) => {
  const isUp = delta >= 0;
  ...
  const tones = {
    green:  {
      ...
      barDark: "rgba(16,185,129,0.75)",   // emerald-500
      barLight:"rgba(16,185,129,0.20)",
      barBg:   "bg-emerald-100",
    },
    rose:   {
      text: "text-rose-500",
      barDark: "rgba(244,63,94,0.75)",    // rose-500
      barLight:"rgba(244,63,94,0.20)",
      barBg:   "bg-rose-100/60",
    },
    indigo: {
      text: "text-indigo-600",
      barDark: "rgba(79,70,229,0.75)",    // indigo-600
