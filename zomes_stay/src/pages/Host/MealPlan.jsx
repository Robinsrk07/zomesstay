...
const MealPlan = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editing) {
        await mealPlanService.updateMealPlan(editing.id, payload);
        showNotification("success", "Meal plan updated successfully");
      } else {
        await mealPlanService.createMealPlan(payload);
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage your property's meal plan offerings</p>
            </div>
            <button
              onClick={() => openModal()}
                ...
                {/* <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('adult_price', e.target.value)}
                      placeholder="0.00"
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                        formErrors.adult_price ? 'border-red-500' : 'border-gray-300'
                      }`}
                    />
                    {formErrors.adult_price && (
                      <p className="text-red-500 text-xs mt-1">{formErrors.adult_price}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                        formErrors.child_price ? 'border-red-500' : 'border-gray-300'
                      }`}
                    />
                    {formErrors.child_price && (
